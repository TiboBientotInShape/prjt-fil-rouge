...
// 📊 Requête pour compter le nombre de questions par questionnaire
$stmtCount = $pdo->query("
...
// On transforme le résultat en tableau associatif [questionnaire_id => nb_questions]
$questionsParTheme = [];
while ($row = $stmtCount->fetch()) {
    $questionsParTheme[$row['questionnaire_id']] = $row['nb_questions'];
}
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden transform hover:scale-105 transition-all duration-300 hover:shadow-2xl">
                ...
                <div class="bg-gradient-to-r <?php echo $quiz['couleur']; ?> p-6 text-white">
                    <div class="flex items-center justify-between mb-3">
                        ...
                        <?php
                        $nb = isset($questionsParTheme[$quiz['id']]) ? $questionsParTheme[$quiz['id']] : 0;
